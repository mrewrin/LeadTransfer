...
SECRET_KEY = "django-insecure-2miiz^a!b7ns^vit+*d(l-)h!7)klk#^&x)sc29a4khu@5(w8g"
...
DATABASES = {
    "default": {
        ...
        "PORT": 5432,  # Порт PostgreSQL, указанный в docker-compose.yml
    }
}
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 10,  # Добавляем пагинацию
}
